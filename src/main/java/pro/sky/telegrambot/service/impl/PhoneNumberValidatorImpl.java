...
public class PhoneNumberValidatorImpl {
    ...
    public static String formatPhoneNumber(String phoneNumber) {
        ...
        if (phoneNumber.matches("^79\\d{9}$")) {
            return phoneNumber.replaceFirst("(79)(\\d{3})(\\d{3})(\\d{2})(\\d{2})", "+7-$1-$2-$3-$4");
        } else if (phoneNumber.matches("^\\+79\\d{9}$")) {
            return phoneNumber.replaceFirst("(\\+79)(\\d{3})(\\d{3})(\\d{2})(\\d{2})", "$1-$2-$3-$4-$5");
        } else if (phoneNumber.matches("^89\\d{9}$")) {
            return phoneNumber.replaceFirst("(89)(\\d{3})(\\d{3})(\\d{2})(\\d{2})", "+7-$1-$2-$3-$4");
        } else if (phoneNumber.matches("^8-9\\d{9}$")) {
            return phoneNumber.replaceFirst("(8-9)(\\d{3})(\\d{3})(\\d{2})(\\d{2})", "+7-$1-$2-$3-$4");
        } else if (phoneNumber.matches("^\\+7-9\\d{9}$")) {
            return phoneNumber.replaceFirst("(\\+7-9)(\\d{3})(\\d{3})(\\d{2})(\\d{2})", "$1-$2-$3-$4-$5");
        } else if (phoneNumber.matches("^7-9\\d{9}$")) {
            return phoneNumber.replaceFirst("(7-9)(\\d{3})(\\d{3})(\\d{2})(\\d{2})", "+7-$1-$2-$3-$4");
        }
